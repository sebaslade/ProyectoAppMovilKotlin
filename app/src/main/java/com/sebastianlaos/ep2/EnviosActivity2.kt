...
class EnviosActivity2 : ComponentActivity() {
                                    ...
                                    items(items = arrayList, itemContent = { envio ->
                                        Card(
                                            ...
                                            modifier = Modifier
                                                ...
                                                .fillMaxWidth()
                                                .clickable {
                                                    seleccionarProducto(envio.get("idempresaenvio").toString())
                                                }
                                        ) {
                                            Column(
    ...
    private fun seleccionarProducto(idempresaenvio: String) {
        val bundle = Bundle().apply {
            putString("idempresaenvio", idempresaenvio)
        }
        val intent = Intent(this, DetalleEnviosActivity::class.java)
